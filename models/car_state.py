...
class Monoplaza:
    ...
    """
    def __init__(self, piloto_estilo: str = "Equilibrado", combustible_inicial: float = 100.0, tiempo_base: float = 82.0):
    ...
    def colocar_neumaticos(self, compuesto_nombre: str, color: str, lambda_deg: float):
    ...
    def avanzar_vuelta(self, num_vuelta: int) -> float:
        ...
        # 2. Componente Continuo Lineal de Combustible (aprox. 1.8 kg consumidos por vuelta)
        consumo = 1.85
        ...
        tiempo_vuelta = self.tiempo_base + (0.14 * perdida_grip) - (0.038 * combustible_quemado)
    ...
    def obtener_estimacion(self) -> float:
        ...
        perdida_grip = 100.0 - self.grip_actual
        combustible_quemado = self.combustible_inicial - self.combustible
        return self.tiempo_base + (0.14 * perdida_grip) - (0.038 * combustible_quemado)
